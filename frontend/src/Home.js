  ...
  return (
    <div style={{ backgroundColor: '#071618', minHeight: '100vh', color: 'white', fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div style={{ textAlign: 'center', padding: '60px 20px' }}>
        ...
        {/* --- Best Animation Experience for Category Buttons --- */}
          ...
          >
            ...
            <div style={{ padding: '30px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '20px' }}>
                ...
                <button style={{ backgroundColor: accentColor, color: '#071618', border: 'none', padding: '12px 25px', borderRadius: '15px', fontWeight: '900' }}>BOOK NOW</button>
              </div>
            </div>
          </div>
        ))}
      ...
      <footer style={{ background: 'rgba(255,255,255,0.02)', padding: '50px 40px', borderTop: '1px solid rgba(255,255,255,0.1)', textAlign: 'center' }}>
        <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginBottom: '20px' }}>
          <div><h4>Contact</h4><p>+94 760 752854</p></div>
          <div><h4>Email</h4><p>info@mrride.com</p></div>
          <div><h4>Follow Us</h4><p>FB | IG | LI</p></div>
        </div>
        <p style={{ opacity: 0.5 }}>© 2026 MR RIDE. Developed by Mohamed Rukshan.</p>
      </footer>
    </div>
  );
}
